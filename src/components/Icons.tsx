/* OKAI Icon-Kollektion
   Stil: Geometrisch, outline-basiert, strokeWidth 1.8 bei 24x24 Viewbox
...
export function IconArrowDiagonal({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconLinkedIn({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/* ============================================
   DIMENSIONS-ICONS (Reifegrad-Check)
   ============================================ */

/* Strategie: Zielscheibe */
...
/* Prozesse: Kreislauf */
export function IconCycle({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M21.5 2v6h-6" />
      <path d="M2.5 22v-6h6" />
      <path d="M21.5 8A10 10 0 0 0 5.64 5.64L2.5 8" />
      <path d="M2.5 16a10 10 0 0 0 15.86 2.36L21.5 16" />
    </svg>
  );
}

/* Daten: Datenbank/Ellipsen */
...
/* Technik: Netzwerk/Nodes */
export function IconNetwork({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/* ============================================
   SPINNENNETZ / RADAR-ICON
   ============================================ */

export function IconRadar({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
      {/* Äußeres Heptagon (vereinfacht als Kreis) */}
      <circle cx="12" cy="12" r="10" />
      <circle cx="12" cy="12" r="5" />
      {/* Achsen */}
      <line x1="12" y1="2" x2="12" y2="22" />
      <line x1="2.7" y1="8.5" x2="21.3" y2="15.5" />
      <line x1="2.7" y1="15.5" x2="21.3" y2="8.5" />
    </svg>
  );
}
...
/* Blitz mit Durchstreichen */
export function IconMythBuster({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" />
...
/* Gehirn/Sandwich (HI→KI→HI) */
export function IconBrainSandwich({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
      {/* Obere Schicht: HI */}
      ...
      <path d="M4 18c0 2 3.58 4 8 4s8-2 8-4" />
    </svg>
  );
}
...
export function IconQuestionBurst({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <line x1="20" y1="4" x2="19.3" y2="4.7" />
      <line x1="4" y1="4" x2="4.7" y2="4.7" />
    </svg>
  );
}
...
/* Stufe 1 KI Durchblick: Auge/Fernglas */
...
/* Stufe 2 KI Roadmap: Karte/Route */
...
/* Stufe 3 KI Lösung: Zahnrad+Blitz */
export function IconGearLightning({ size = 24, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 1l1.27 3.04a2 2 0 0 0 1.69 1.27l3.04.27-2.32 2.08a2 2 0 0 0-.64 1.96l.7 2.98-2.64-1.56a2 2 0 0 0-2.06 0L8.4 12.6l.7-2.98a2 2 0 0 0-.64-1.96L6.14 5.58l3.04-.27a2 2 0 0 0 1.69-1.27L12 1z" />
      {/* Blitz im Zentrum */}
      <polygon points="13 11 11 15 14 15 12 19" />
    </svg>
  );
}

/* Stufe 4 KI Autopilot: Rakete */
